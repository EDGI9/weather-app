...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _classes_weather_item__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./classes/weather-item */
    ...
    var _components_search_input_search_input_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    var _components_card_card_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./components/card/card.component */
    "./src/app/components/card/card.component.ts");
    /* harmony import */


    var _components_profile_item_profile_item_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./components/profile-item/profile-item.component */
    "./src/app/components/profile-item/profile-item.component.ts");
    /* harmony import */


    var _components_weather_item_weather_item_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./components/weather-item/weather-item.component */
    ...
    function AppComponent_app_card_5_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_app_card_5_Template_app_card_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);

          var profileItem_r2 = ctx.$implicit;

          var ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r3.onLoadProfile(profileItem_r2);
        });

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "app-profile-item", 9);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("delete", function AppComponent_app_card_5_Template_app_profile_item_delete_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);
          ...
          return ctx_r5.onDeleteProfile($event, profileItem_r2);
        });
    ...
    function AppComponent_app_card_10_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var weatherItem_r6 = ctx.$implicit;
    ...
    /*#__PURE__*/
    function () {
      function AppComponent(_weatherService, _profileService) {
      ...
      _createClass(AppComponent, [{
        key: "onDeleteProfile",
        value: function onDeleteProfile(event, profile) {
        ...
        value: function onSaveProfile() {
          var cities = this._weatherService.getWeatherItems().map(function (item) {
            return item.name;
          });
        ...
        key: "onLoadProfile",
        value: function onLoadProfile(profile) {
          var _this = this;

          this._weatherService.clearWeatherItems();

          for (var i = 0; i < profile.cities.length; i++) {
            this._weatherService.searchWeatherData(profile.cities[i]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])()).subscribe(function (response) {
              var weatherItem = new _classes_weather_item__WEBPACK_IMPORTED_MODULE_2__["WeatherItem"](response.name, response.weather[0].description, response.main.temp);
        ...
        key: "onSearchTextInput",
        value: function onSearchTextInput(string) {
          var _this2 = this;

          this._weatherService.searchWeatherData(string).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(300), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
            _this2.foundResult = {
              name: error.error.message
            };
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(error);
          })).subscribe(function (response) {
            _this2.foundResult = response;
          });
        }
      }, {
        key: "onSearchWeather",
        value: function onSearchWeather(form) {
          var _this3 = this;

          this._weatherService.searchWeatherData(form.value.searchInput).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
            _this3.foundResult = {
              name: error.error.message
            };
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(error);
            ...
            _this3._weatherService.addWeatherItem(weatherItem);
          });
        }
      }, {
        key: "ngOnInit",
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_weather_service__WEBPACK_IMPORTED_MODULE_1__["WeatherService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_profile_service__WEBPACK_IMPORTED_MODULE_5__["ProfileService"]));
    };

    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: AppComponent,
      selectors: [["app-root"]],
      features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_services_weather_service__WEBPACK_IMPORTED_MODULE_1__["WeatherService"], _services_profile_service__WEBPACK_IMPORTED_MODULE_5__["ProfileService"]])],
      decls: 12,
      vars: 3,
      consts: [[1, "s-sidebar"], [1, "u-horizontal-margin-1"], ["buttonText", "Save", 3, "click"], ["extraClasses", "c-card--blue ", 3, "click", 4, "ngFor", "ngForOf"], ["role", "main", 1, "content"], [3, "foundResult", "onSearchText", "onSearchTextInput"], [1, "card-container"], [4, "ngFor", "ngForOf"], ["extraClasses", "c-card--blue ", 3, "click"], ["extraClasses", "c-profile-item--text-white", 3, "profile-item", "delete"], [3, "weather-item"]],
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_app_button_click_4_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onSearchText", function AppComponent_Template_app_search_input_onSearchText_8_listener($event) {
            return ctx.onSearchWeather($event);
          })("onSearchTextInput", function AppComponent_Template_app_search_input_onSearchTextInput_8_listener($event) {
            return ctx.onSearchTextInput($event);
          });
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_weather_item_weather_item_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./components/weather-item/weather-item.component */
    "./src/app/components/weather-item/weather-item.component.ts");
    /* harmony import */
    ...
    var _components_button_button_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./components/button/button.component */
    "./src/app/components/button/button.component.ts");
    /* harmony import */
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _components_card_card_component__WEBPACK_IMPORTED_MODULE_6__["CardComponent"], _components_nav_bar_nav_bar_component__WEBPACK_IMPORTED_MODULE_7__["NavBarComponent"], _components_footer_footer_component__WEBPACK_IMPORTED_MODULE_8__["FooterComponent"], _components_weather_item_weather_item_component__WEBPACK_IMPORTED_MODULE_9__["WeatherItemComponent"], _components_search_input_search_input_component__WEBPACK_IMPORTED_MODULE_10__["SearchInputComponent"], _components_button_button_component__WEBPACK_IMPORTED_MODULE_11__["ButtonComponent"], _components_sidebar_sidebar_component__WEBPACK_IMPORTED_MODULE_12__["SidebarComponent"], _components_profile_item_profile_item_component__WEBPACK_IMPORTED_MODULE_13__["ProfileItemComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppClassesProfileItemTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProfileItem", function () {
      return ProfileItem;
    });

    var ProfileItem =
    /*#__PURE__*/
    _createClass(function ProfileItem(profileName, cities) {
  ...
  /***/
  function srcAppClassesWeatherItemTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WeatherItem", function () {
      return WeatherItem;
    });

    var WeatherItem =
    /*#__PURE__*/
    _createClass(function WeatherItem(name, weather, temperature) {
  ...
  function srcAppComponentsButtonButtonComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ButtonComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 1,
      consts: [["type", "buttonType", 1, "c-button"]],
  ...
  /***/
  function srcAppComponentsProfileItemProfileItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProfileItemComponent", function () {
    ...
    var ProfileItemComponent =
    /*#__PURE__*/
    function () {
      function ProfileItemComponent() {
        _classCallCheck(this, ProfileItemComponent);

        this["delete"] = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
      }

      _createClass(ProfileItemComponent, [{
        key: "onDelete",
    ...
    ProfileItemComponent.ɵfac = function ProfileItemComponent_Factory(t) {
      return new (t || ProfileItemComponent)();
    };

    ProfileItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ProfileItemComponent,
      selectors: [["app-profile-item"]],
      inputs: {
        extraClasses: "extraClasses",
      ...
      decls: 7,
      vars: 4,
      consts: [[1, "c-profile-item"], [1, "c-profile-item__title"], [1, "c-profile-item__city-list"], [1, "c-profile-item__close-button", 3, "click"]],
      template: function ProfileItemComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileItemComponent_Template_span_click_5_listener($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProfileItemComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsSearchInputSearchInputComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(SearchInputComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.searchStream.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(300), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])()).subscribe(function (string) {
            _this4.onSearchTextInput.emit(string);
          });
        }
      }]);
    ...
    SearchInputComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 9,
      vars: 2,
      consts: [[1, "c-search-input"], [1, "c-search-input__input-container", 3, "formGroup", "ngSubmit"], ["for", "searchInput", 1, "c-search-input__label"], ["formControlName", "searchInput", "name", "searchInput", "required", "", 1, "c-search-input__input-field", 3, "input"], ["buttonType", "submit", "buttonText", "Submit"], [1, "c-search-input__search-results"]],
      template: function SearchInputComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function SearchInputComponent_Template_form_ngSubmit_1_listener() {
            return ctx.onSubmit();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function SearchInputComponent_Template_input_input_4_listener() {
  ...
  /***/
  function srcAppComponentsWeatherItemWeatherItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    WeatherItemComponent.ɵfac = function WeatherItemComponent_Factory(t) {
      return new (t || WeatherItemComponent)();
    };
    ...
    WeatherItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 7,
      vars: 3,
      consts: [[1, "c-weather-item"], [1, "c-weather-item__name"], [1, "c-weather-item__temperature"], [1, "c-weather-item__weather"]],
      template: function WeatherItemComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", ctx.weatherItem.temperature, " \xBAC ");
  ...
  function srcAppServicesProfileServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _classes_profile_item__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ../classes/profile-item */
    "./src/app/classes/profile-item.ts");
    /* harmony import */


    var _store_profile_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../store/profile.data */
    ...
    function () {
      ...
      _createClass(ProfileService, [{
        ...
        key: "saveNewProfile",
        value: function saveNewProfile(cities) {
          var profileName = "Profile " + _store_profile_data__WEBPACK_IMPORTED_MODULE_1__["PROFILE_ITEMS"].length;
          var profile = new _classes_profile_item__WEBPACK_IMPORTED_MODULE_0__["ProfileItem"](profileName, cities);

          if (_store_profile_data__WEBPACK_IMPORTED_MODULE_1__["PROFILE_ITEMS"].map(function (profile) {
            return profile.profileName;
          }).indexOf(profileName) < 0) {
  ...
  function srcAppServicesWeatherServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _store_weather_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../store/weather.data */
    ...
    function () {
      ...
      _createClass(WeatherService, [{
        ...
        key: "addWeatherItem",
        value: function addWeatherItem(weatherItem) {
          if (_store_weather_data__WEBPACK_IMPORTED_MODULE_1__["WEATHER_ITEMS"].map(function (e) {
            return e.name;
          }).indexOf(weatherItem.name) < 0) {
            _store_weather_data__WEBPACK_IMPORTED_MODULE_1__["WEATHER_ITEMS"].push(weatherItem);
          }
        }
      }, {
        key: "clearWeatherItems",
        value: function clearWeatherItems() {
          _store_weather_data__WEBPACK_IMPORTED_MODULE_1__["WEATHER_ITEMS"].splice(0);
        }
      }, {
        key: "searchWeatherData",
        value: function searchWeatherData(cityName) {
          return this._http.get("https://api.openweathermap.org/data/2.5/weather?q=" + cityName + "&APPID=927d100a485672b0684c432f47a22926" + "&units=metric", {
            responseType: "json"
  ...
  /***/
  function srcAppStoreProfileDataTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PROFILE_ITEMS", function () {
    ...
    var PROFILE_ITEMS = [new _classes_profile_item__WEBPACK_IMPORTED_MODULE_0__["ProfileItem"]("Default Profile", ["Lisbon", "Paris", "London"])];
    /***/
  },
  ...
  /***/
  function srcAppStoreWeatherDataTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WEATHER_ITEMS", function () {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/runner/work/weather-app/weather-app/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
